package com.cn.test.methodreference;
...
public class MethodReference {
	...
	public int myCompareM(Person p1, Person p2) {
		return p1.getName().compareTo(p2.getName());
	}
	...
	public static void main(String[] args) {
		...
		// 方法引用::引用特定类型的任意对象的实例方法
		/*
		 * Arrays.sort(persons3, MethodReference::myCompareM); System.out.print(
		 * "排序后: "); printArray(persons3);
		 */
	}
	...
	static class PersonFactory {
		...
		public PersonFactory(Supplier<Person> p) {
			this.supplier = p;
		}
